...
instance and requires snapshot-and-restore to idle. On a self-hosted host the
Docker container runtime reconciles desired state; routing and cold connection
brokering stay outside the scheduler.
