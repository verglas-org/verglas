...
Analytics applications remain independent consumers of the open Iceberg and
S3-compatible surfaces. They run through the general container lifecycle rather
than adding application-specific runtime clients or resource APIs to the cache
server. Their project files and rebuildable materializations are application
state; customer tables and object storage remain authoritative.
