...
- **PP9 — Cloudflare-shaped management.** Wrangler/API create/list/get/delete,
  immutable resource behavior, Stream binding generation, schema validation,
  limits, and metrics match the documented current surface; every deliberate
  extension or documentation gap is labeled.
