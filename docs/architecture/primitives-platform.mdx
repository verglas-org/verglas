...
The platform has exactly six products. Each product is either tenant Worker code
...
Object components through Wasmtime under celld/Firecracker isolation, owns local
...
alternate transaction envelope, DO-owned vector/graph mutation domain, direct
...
repository defines and runs the six-product data plane plus the strict manifest
