...
| --- | --- |
| `verglas` | Public lakehouse runtime (cache and consensus engine), TypeScript SDK, documentation, and RIME package. |
...
| TypeScript SDK | Use the public S3, catalog, vector, graph, and administrative contracts. |
| RIME | Package the evaluated parallel software-engineering skill for supported agent hosts. |
