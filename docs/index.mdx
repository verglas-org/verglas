...
Iceberg tables in your catalog and object store, then puts a bounded DRAM/NVMe
cache, query API, workers, long-running services, dashboards, and SDKs on the
path your data already takes.
