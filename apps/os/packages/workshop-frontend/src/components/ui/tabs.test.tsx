...
describe('Tabs', () => {
  ...
  it('links controls to their content and changes selection with the keyboard', () => {
    ...
    const [overview, metrics] = Array.from(container.querySelectorAll<HTMLButtonElement>('[role="tab"]'))
    ...
    act(() => overview.dispatchEvent(new KeyboardEvent('keydown', { bubbles: true, key: 'ArrowRight' })))
