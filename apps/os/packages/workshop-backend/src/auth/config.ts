...
// "Continue with ..." button alongside the normal email/password form (unless password auth is
...
// Whether email/password login + signup is available. Enabled by default. An installation can
