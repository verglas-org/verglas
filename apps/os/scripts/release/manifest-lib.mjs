...
//
// This is the open-source analog of workspaces-internal's generate-wrangler-prod.js: it parses each
...
const HANDLED_CONFIG_KEYS = new Set([
  ...
  "assets", "vars",
  // Browser Rendering (Workspace PDF exports). Unlike artifacts it is generally available, so it
