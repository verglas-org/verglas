...
- #0: Consume the published JavaScript Worker SDK for component and runtime-surface tests. Sink no longer reaches into an SDK source tree owned by another repository.
