...
- #39: Added typed dashboard create, list, show, delete, and refresh operations to the TypeScript client. The transport now supports DELETE and both SDK parity manifests cover the complete dashboard surface.
