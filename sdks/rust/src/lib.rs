//! The Rust SDK for the agent-data platform.
//!
//! One crate owns the public data-plane clients and wire contracts:
//!
...
//! - [`grant`]: a generic memory grant contract for runtime hosts.
...
pub use client::{
    ChangeEvent, Client, ClientError, ColumnSpec, ConnectOptions, DataClient, Database,
    DeliveryReceipt, EnsureTable, IngestResult, Namespace, NamespaceManifest,
    NamespaceMethodManifest, NamespaceMethodMode, NamespaceStream, PartitionSpec,
    TableChangeDelivery, TableChangeStream, TableDefinition, TableSubscriptionEvent,
};
