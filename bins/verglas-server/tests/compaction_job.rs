//! Acceptance for compaction as a manual server mechanism.
//!
//! The server does not register or schedule compaction. Policy belongs to a
...
use verglas_server::admin::{self, Health, Slots, TablesSlot};
