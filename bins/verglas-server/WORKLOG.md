...
- #42: Removed Rill credentials, project mutation, and dashboard routes from server startup. The optional Rill container now calls the independent Verglas query role.
