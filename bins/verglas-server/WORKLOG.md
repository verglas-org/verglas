...
- #34: Removed Rill environment variables and dashboard-runtime startup wiring from the server. The base Compose application now starts only Verglas storage and the optional worker scheduler, leaving analytics applications to the OS container runtime.
