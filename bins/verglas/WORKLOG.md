...
- #34: Removed the Rill-specific `dashboard` command group and its HTTP client tests. The CLI now reports `dashboard` as an unknown command because analytics applications use the general OS container lifecycle.
