...
- #42: Removed the dashboard command group because Rill owns dashboard resources in its project. The CLI retains only Verglas cache, query, table, and platform operations.
