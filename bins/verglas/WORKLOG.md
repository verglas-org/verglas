...
- #39: Routed every dashboard command through the Rust SDK's typed operations and added `verglas dashboard refresh`. Refresh reloads the table's latest Iceberg metadata pointer instead of leaving Rill materialized at an older backtest snapshot.
