use serde::Serialize;
use verglas_catalog_core::service::authz::{
...
/// Backend-neutral Verglas action names carried in control-plane credential scopes.
...
impl VerglasAction {
    ...
    /// Maps one Catalog table operation to its minimum safe Verglas permission.
    #[must_use]
