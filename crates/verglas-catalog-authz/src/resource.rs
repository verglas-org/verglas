...
/// Deterministically maps Catalog entities into dynamic Verglas database trees.
...
impl ResourceMapper {
    ...
    /// Shared Catalog control-plane root pre-provisioned by Verglas.
    #[must_use]
    ...
    pub fn role(&self, id: RoleId) -> String {
        format!("catalog/role/{id}")
    }

    #[must_use]
    pub fn tag(&self, id: TagDefinitionId) -> String {
        format!("catalog/tag/{id}")
    }
}
