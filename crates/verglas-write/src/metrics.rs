...
//! after consensus commit. Failed propagations and repairs are counted so the bounded-lag and
...
pub struct WritebackMetrics {
    ...
    /// Retained compatibility counter; consensus write-back never increments it.
