//! Serializable Catalog catalog documents stored in warehouse CRaft groups.
//!
//! These wire records deliberately carry stable identifiers and Iceberg REST
//! metadata locations. Catalog reconstructs richer response objects at its
...
pub struct WarehouseDocument {
    /// Stable Catalog warehouse UUID text.
    pub id: String,
    /// Owning Catalog project UUID text.
    ...
    #[serde(default)]
    pub version: i64,
    /// Whether Catalog governance protects this warehouse from destructive actions.
    #[serde(default)]
    pub protected: bool,
}
...
pub struct NamespaceDocument {
    /// Stable Catalog namespace UUID text.
    pub id: String,
    ...
    #[serde(default)]
    pub version: i64,
    /// Whether Catalog governance protects this namespace from destructive actions.
    #[serde(default)]
    pub protected: bool,
}
...
pub struct TableDocument {
    /// Stable Catalog table UUID text.
    pub id: String,
    /// Owning warehouse UUID text.
    pub warehouse_id: String,
    ...
    #[serde(default)]
    pub version: i64,
    /// Whether Catalog governance protects this table from destructive actions.
    #[serde(default)]
    pub protected: bool,
}
...
pub struct ViewDocument {
    ...
    #[serde(default)]
    pub version: i64,
    /// Whether Catalog governance protects this view from destructive actions.
    #[serde(default)]
    pub protected: bool,
}
