...
//!
//! After a hosted catalog commit succeeds, Catalog POSTs one message per
...
use verglas_catalog_core::api::iceberg::v1::TableIdent;
...
#[cfg(test)]
mod tests {
    use verglas_catalog_core::api::iceberg::v1::{NamespaceIdent, TableIdent};
