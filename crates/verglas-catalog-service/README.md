...
The upstream Lakekeeper code in this subworkspace is licensed under the
[Apache License, Version 2.0](LICENSE). Verglas-authored adapters are licensed
under FSL-1.1-ALv2. See [LICENSING.md](LICENSING.md) for the crate boundary.
