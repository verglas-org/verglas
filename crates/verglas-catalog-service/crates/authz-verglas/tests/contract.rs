use lakekeeper::service::{ProjectId, TableId, WarehouseId, authz::CatalogTableAction};
use lakekeeper_authz_verglas::{ResourceMapper, VerglasAction};
...
fn maps_catalog_ids_without_a_static_database_root() {
    ...
    assert_eq!(
        ...
        format!("lakekeeper/project/{project}")
    );
    assert_eq!(
