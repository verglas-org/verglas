...
/// Lakekeeper's SQL-backed management services.
///
...
/// A `CRaft` catalog cannot accidentally mount management or task endpoints.
...
/// middleware used by Lakekeeper's full server before binding the listener.
