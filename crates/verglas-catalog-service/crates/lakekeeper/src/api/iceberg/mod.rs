...
pub mod v1 {
    ...
    /// Builds the complete Iceberg router, including configuration and metrics.
...
/// Returns the canonical Iceberg REST routes implemented by the mounted catalog router.
#[must_use]
