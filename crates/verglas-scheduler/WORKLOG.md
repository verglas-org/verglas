...
- #109: Added explicit building, ready, and failed worker revision states with a separate image digest. Dispatch accepts only ready revisions whose image tag matches the registered digest.
