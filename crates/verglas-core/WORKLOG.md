...
- #42: Removed Rill network and analytics lifecycle fields from server configuration. Rill now owns its project and connects to the ordinary Verglas query surface.
