...
use verglas_iceberg_ext::catalog::TableUpdateKind;
...
/// authorizer does not manage assignments, Catalog persists them to the
...
#[cfg_attr(feature = "open-api", schema(as=CatalogUserAction))]
...
#[cfg_attr(feature = "open-api", derive(utoipa::ToSchema))]
#[cfg_attr(feature = "open-api", schema(as=CatalogServerAction))]
#[strum(serialize_all = "snake_case")]
#[serde(rename_all = "snake_case", tag = "action")]
...
#[cfg_attr(feature = "open-api", derive(utoipa::ToSchema))]
#[cfg_attr(feature = "open-api", schema(as=CatalogProjectAction))]
#[strum(serialize_all = "snake_case")]
#[serde(rename_all = "snake_case", tag = "action")]
...
#[cfg_attr(feature = "open-api", derive(utoipa::ToSchema))]
#[cfg_attr(feature = "open-api", schema(as=CatalogRoleAction))]
#[strum(serialize_all = "snake_case")]
#[serde(rename_all = "snake_case", tag = "action")]
...
#[cfg_attr(feature = "open-api", derive(utoipa::ToSchema))]
#[cfg_attr(feature = "open-api", schema(as=CatalogWarehouseAction))]
#[serde(rename_all = "snake_case", tag = "action")]
#[strum(serialize_all = "snake_case")]
...
#[cfg_attr(feature = "open-api", derive(utoipa::ToSchema))]
#[cfg_attr(feature = "open-api", schema(as=CatalogNamespaceAction))]
#[serde(rename_all = "snake_case", tag = "action")]
#[strum(serialize_all = "snake_case")]
...
#[cfg_attr(feature = "open-api", derive(utoipa::ToSchema))]
#[cfg_attr(feature = "open-api", schema(as=CatalogTableAction))]
#[serde(rename_all = "snake_case", tag = "action")]
#[strum(serialize_all = "snake_case")]
...
#[cfg_attr(feature = "open-api", derive(utoipa::ToSchema))]
#[cfg_attr(feature = "open-api", schema(as=CatalogViewAction))]
#[serde(rename_all = "snake_case", tag = "action")]
#[strum(serialize_all = "snake_case")]
...
#[cfg_attr(feature = "open-api", derive(utoipa::ToSchema))]
#[cfg_attr(feature = "open-api", schema(as=CatalogGenericTableAction))]
#[serde(rename_all = "snake_case", tag = "action")]
#[strum(serialize_all = "snake_case")]
...
#[cfg_attr(feature = "open-api", derive(utoipa::ToSchema))]
#[cfg_attr(feature = "open-api", schema(as=CatalogTagAction))]
#[strum(serialize_all = "snake_case")]
#[serde(rename_all = "snake_case", tag = "action")]
...
#[cfg_attr(feature = "open-api", derive(utoipa::ToSchema))]
#[cfg_attr(feature = "open-api", schema(as=CatalogServerActionKind))]
#[serde(rename_all = "snake_case", tag = "action")]
...
#[derive(Debug, Clone, Copy, Eq, PartialEq, Serialize, Deserialize)]
#[cfg_attr(feature = "open-api", derive(utoipa::ToSchema))]
#[cfg_attr(feature = "open-api", schema(as=CatalogProjectActionKind))]
#[serde(rename_all = "snake_case", tag = "action")]
...
#[derive(Debug, Clone, Copy, Eq, PartialEq, Serialize, Deserialize)]
#[cfg_attr(feature = "open-api", derive(utoipa::ToSchema))]
#[cfg_attr(feature = "open-api", schema(as=CatalogRoleActionKind))]
#[serde(rename_all = "snake_case", tag = "action")]
...
#[derive(Debug, Clone, Copy, Eq, PartialEq, Serialize, Deserialize)]
#[cfg_attr(feature = "open-api", derive(utoipa::ToSchema))]
#[cfg_attr(feature = "open-api", schema(as=CatalogWarehouseActionKind))]
#[serde(rename_all = "snake_case", tag = "action")]
...
#[derive(Debug, Clone, Copy, Eq, PartialEq, Serialize, Deserialize)]
#[cfg_attr(feature = "open-api", derive(utoipa::ToSchema))]
#[cfg_attr(feature = "open-api", schema(as=CatalogNamespaceActionKind))]
#[serde(rename_all = "snake_case", tag = "action")]
...
#[derive(Debug, Clone, Copy, Eq, PartialEq, Serialize, Deserialize)]
#[cfg_attr(feature = "open-api", derive(utoipa::ToSchema))]
#[cfg_attr(feature = "open-api", schema(as=CatalogTableActionKind))]
#[serde(rename_all = "snake_case", tag = "action")]
...
#[derive(Debug, Clone, Copy, Eq, PartialEq, Serialize, Deserialize)]
#[cfg_attr(feature = "open-api", derive(utoipa::ToSchema))]
#[cfg_attr(feature = "open-api", schema(as=CatalogViewActionKind))]
#[serde(rename_all = "snake_case", tag = "action")]
    ...
    Self: Send + Sync + 'static + HealthExt + Clone + std::fmt::Debug,
{
    ...
    /// Whether the authorizer authenticates opaque bearer tokens itself.
    ///
    /// When enabled, the router retains the bearer in redacted request
    /// metadata and skips the configured OIDC authenticator. Every concrete
    /// authorization decision must validate that bearer; accepting it here
    ...
    /// `catalog`-native and unmanaged roles stay writable exactly as before.
    ///
    /// Implementors MUST NOT include the native `catalog` namespace or the
    ...
    /// If unsupported is returned, Catalog will run checks for every project individually using
    ...
    /// Hook that is called when a user is created or first provisioned.
...
pub mod tests {
    ...
    /// Catalog-internal actors must bypass even data-plane generic-table
    /// actions, matching the table/view behaviour.
    #[tokio::test]
    async fn test_catalog_internal_bypasses_all_generic_table_actions() {
        let authz = HidingAuthorizer::new();
        authz.block_action(
            format!("generic_table:{:?}", CatalogGenericTableAction::WriteData).as_str(),
        );

        let md = RequestMetadata::new_catalog_internal(Uuid::now_v7());
        let warehouse = ResolvedWarehouse::new_with_id(Uuid::nil().into());
        let hierarchy = NamespaceHierarchy {
            namespace: NamespaceWithParent {
                namespace: Arc::new(Namespace {
        ...
        assert!(
            allowed,
            "CatalogInternal must bypass WriteData (data-plane) on generic tables too",
        );
    }

    /// Catalog-internal actors must bypass even data-plane view actions,
    /// matching the table behaviour.
    #[tokio::test]
    async fn test_catalog_internal_bypasses_all_view_actions() {
        let authz = HidingAuthorizer::new();
        authz.block_action(format!("view:{:?}", CatalogViewAction::Select).as_str());
        ...
        assert!(
            allowed,
            "CatalogInternal must bypass Select (data-plane) on views too",
        );
    }

    /// Catalog-internal actors must bypass even data-plane table actions,
    /// matching the pre-existing `has_admin_privileges()` contract.
    #[tokio::test]
    async fn test_catalog_internal_bypasses_all_table_actions() {
        let authz = HidingAuthorizer::new();
        authz.block_action(format!("table:{:?}", CatalogTableAction::WriteData).as_str());
        ...
        assert!(
            allowed,
            "CatalogInternal must bypass WriteData (data-plane) too",
        );
    }
}
