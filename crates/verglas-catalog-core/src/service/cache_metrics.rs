...
pub(crate) const METRIC_CACHE_SIZE: &str = "catalog_cache_size";
pub(crate) const METRIC_CACHE_HITS_TOTAL: &str = "catalog_cache_hits_total";
pub(crate) const METRIC_CACHE_MISSES_TOTAL: &str = "catalog_cache_misses_total";
...
pub(crate) const METRIC_ROLE_MEMBERSHIP_EDGE_FANOUT_USERS: &str =
    "catalog_role_membership_edge_fanout_users";
