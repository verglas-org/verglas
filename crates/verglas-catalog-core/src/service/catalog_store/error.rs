...
macro_rules! define_transparent_error {
    (
        ...
        pastey::paste! {
            ...
            impl From<$error_name> for verglas_iceberg_ext::catalog::rest::ErrorModel {
            ...
            impl From<$error_name> for verglas_iceberg_ext::catalog::rest::IcebergErrorResponse {
                fn from(err: $error_name) -> Self {
                    verglas_iceberg_ext::catalog::rest::ErrorModel::from(err).into()
                }
            }
        }
    };
