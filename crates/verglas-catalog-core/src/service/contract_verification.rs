...
use verglas_iceberg_ext::catalog::rest::{ErrorModel, ViewUpdate};
...
///     use verglas_catalog_core::service::{TabularId, contract_verification::{ContractVerification, ContractVerificationOutcome}};
///     use verglas_iceberg_ext::catalog::rest::{ErrorModel, ViewUpdate};
///
///     #[derive(Debug)]
...
impl ContractVerificationOutcome {
    ...
    ///
    /// ```rust
    ///     use verglas_catalog_core::service::contract_verification::ContractVerificationOutcome;
