...
//! ```
//! use std::str::FromStr;
//! use verglas_catalog_core::utils::time_conversion::iso_8601_duration_to_chrono;
//!
...
/// use verglas_catalog_core::utils::time_conversion::iso8601_duration_serde;
///
...
/// use chrono::Duration;
/// use serde::{Deserialize, Serialize};
/// use verglas_catalog_core::utils::time_conversion::iso8601_option_duration_serde;
///
/// #[derive(Serialize, Deserialize)]
/// struct Config {
...
/// ```
/// use chrono::Duration;
/// use verglas_catalog_core::utils::time_conversion::chrono_to_iso_8601_duration;
///
