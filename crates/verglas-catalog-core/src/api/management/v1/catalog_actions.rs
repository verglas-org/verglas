...
action_response!(GetCatalogRoleActionsResponse, CatalogRoleActionKind);
action_response!(GetCatalogServerActionsResponse, CatalogServerActionKind);
action_response!(GetCatalogProjectActionsResponse, CatalogProjectActionKind);
action_response!(
    GetCatalogWarehouseActionsResponse,
    CatalogWarehouseActionKind
);
action_response!(
    GetCatalogNamespaceActionsResponse,
    CatalogNamespaceActionKind
);
action_response!(GetCatalogTableActionsResponse, CatalogTableActionKind);
action_response!(GetCatalogViewActionsResponse, CatalogViewActionKind);
action_response!(
    GetCatalogGenericTableActionsResponse,
    CatalogGenericTableAction
);
action_response!(GetCatalogUserActionsResponse, CatalogUserAction);
