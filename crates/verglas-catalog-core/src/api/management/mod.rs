...
pub mod v1 {
    ...
    use catalog_actions::{
        GetCatalogGenericTableActionsResponse, GetCatalogNamespaceActionsResponse,
        GetCatalogProjectActionsResponse, GetCatalogRoleActionsResponse,
        GetCatalogServerActionsResponse, GetCatalogTableActionsResponse,
        GetCatalogUserActionsResponse, GetCatalogViewActionsResponse,
        GetCatalogWarehouseActionsResponse, get_allowed_generic_table_actions,
    ...
    use crate::{
        ...
        api::{
            ...
            management::v1::{
                catalog_actions::GetAccessQuery,
    ...
    responses(
        (status = 200, body = GetCatalogServerActionsResponse),
        (status = "4XX", body = IcebergErrorResponse),
    )
    ))]
    ...
    ) -> Result<(StatusCode, Json<GetCatalogServerActionsResponse>)> {
        let relations = get_allowed_server_actions(api_context, metadata, query).await?;

        Ok((
            StatusCode::OK,
            Json(GetCatalogServerActionsResponse {
    ...
    /// Bootstrap
    ///
    /// Initializes the Catalog server and sets the initial administrator account.
    ...
    #[cfg_attr(feature = "open-api", utoipa::path(
        ...
        responses(
            (status = 200, body = GetCatalogUserActionsResponse),
            (status = "4XX", body = IcebergErrorResponse),
        )
    ))]
    async fn get_user_actions<C: CatalogStore, A: Authorizer, S: SecretStore>(
        ...
        Extension(metadata): Extension<RequestMetadata>,
        Query(query): Query<GetAccessQuery>,
    ) -> Result<(StatusCode, Json<GetCatalogUserActionsResponse>)> {
        let relations =
            get_allowed_user_actions(api_context, metadata, query, Arc::new(user_id)).await?;

        Ok((
            StatusCode::OK,
            Json(GetCatalogUserActionsResponse {
                allowed_actions: relations,
            }),
        ))
    }
    ...
    responses(
        (status = 200, body = GetCatalogRoleActionsResponse),
        (status = "4XX", body = IcebergErrorResponse),
    )
    ))]
    async fn get_role_actions<A: Authorizer, C: CatalogStore, S: SecretStore>(
        ...
        Extension(metadata): Extension<RequestMetadata>,
        Query(query): Query<GetAccessQuery>,
    ) -> Result<(StatusCode, Json<GetCatalogRoleActionsResponse>)> {
        let relations = get_allowed_role_actions(api_context, metadata, query, role_id).await?;

        Ok((
            StatusCode::OK,
            Json(GetCatalogRoleActionsResponse {
                allowed_actions: relations,
            }),
        ))
    }
    ...
    responses(
        (status = 200, body = GetCatalogProjectActionsResponse),
        (status = "4XX", body = IcebergErrorResponse),
    )
    ))]
    async fn get_project_actions<A: Authorizer, C: CatalogStore, S: SecretStore>(
        ...
        Extension(metadata): Extension<RequestMetadata>,
        Query(query): Query<GetAccessQuery>,
    ) -> Result<(StatusCode, Json<GetCatalogProjectActionsResponse>)> {
        ...
        Ok((
            StatusCode::OK,
            Json(GetCatalogProjectActionsResponse {
    ...
    responses(
        (status = 200, body = GetCatalogWarehouseActionsResponse),
        (status = "4XX", body = IcebergErrorResponse),
    )
    ))]
    async fn get_warehouse_actions<A: Authorizer, C: CatalogStore, S: SecretStore>(
        ...
        Extension(metadata): Extension<RequestMetadata>,
        Query(query): Query<GetAccessQuery>,
    ) -> Result<(StatusCode, Json<GetCatalogWarehouseActionsResponse>)> {
        let relations =
        ...
        Ok((
            StatusCode::OK,
            Json(GetCatalogWarehouseActionsResponse {
                allowed_actions: relations,
            }),
        ))
    }
    ...
    responses(
        (status = 200, body = GetCatalogTableActionsResponse),
        (status = "4XX", body = IcebergErrorResponse),
    )
    ))]
    async fn get_table_actions<A: Authorizer, C: CatalogStore, S: SecretStore>(
        ...
        Extension(metadata): Extension<RequestMetadata>,
        Query(query): Query<GetAccessQuery>,
    ) -> Result<(StatusCode, Json<GetCatalogTableActionsResponse>)> {
        ...
        Ok((
            StatusCode::OK,
            Json(GetCatalogTableActionsResponse {
                allowed_actions: relations,
            }),
        ))
    }
    ...
    responses(
        (status = 200, body = GetCatalogViewActionsResponse),
        (status = "4XX", body = IcebergErrorResponse),
    )
    ))]
    async fn get_view_actions<A: Authorizer, C: CatalogStore, S: SecretStore>(
        ...
        Extension(metadata): Extension<RequestMetadata>,
        Query(query): Query<GetAccessQuery>,
    ) -> Result<(StatusCode, Json<GetCatalogViewActionsResponse>)> {
        ...
        Ok((
            StatusCode::OK,
            Json(GetCatalogViewActionsResponse {
                allowed_actions: relations,
            }),
        ))
    }
    ...
    responses(
        (status = 200, body = GetCatalogGenericTableActionsResponse),
        (status = "4XX", body = IcebergErrorResponse),
    )
    ))]
    async fn get_generic_table_actions<A: Authorizer, C: CatalogStore, S: SecretStore>(
        ...
        Extension(metadata): Extension<RequestMetadata>,
        Query(query): Query<GetAccessQuery>,
    ) -> Result<(StatusCode, Json<GetCatalogGenericTableActionsResponse>)> {
        ...
        Ok((
            StatusCode::OK,
            Json(GetCatalogGenericTableActionsResponse {
                allowed_actions: relations,
            }),
        ))
    }
    ...
    responses(
        (status = 200, body = GetCatalogNamespaceActionsResponse),
        (status = "4XX", body = IcebergErrorResponse),
    )
    ))]
    async fn get_namespace_actions<A: Authorizer, C: CatalogStore, S: SecretStore>(
        ...
        Extension(metadata): Extension<RequestMetadata>,
        Query(query): Query<GetAccessQuery>,
    ) -> Result<(StatusCode, Json<GetCatalogNamespaceActionsResponse>)> {
        ...
        Ok((
            StatusCode::OK,
            Json(GetCatalogNamespaceActionsResponse {
                allowed_actions: relations,
            }),
        ))
    }
