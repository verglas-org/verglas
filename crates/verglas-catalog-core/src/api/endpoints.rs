...
generate_endpoints! {
    ...
    enum GenericTableV1 {
        CreateGenericTable(POST, "/catalog/v1/{prefix}/namespaces/{namespace}/generic-tables"),
        ListGenericTables(GET, "/catalog/v1/{prefix}/namespaces/{namespace}/generic-tables"),
        LoadGenericTable(GET, "/catalog/v1/{prefix}/namespaces/{namespace}/generic-tables/{table}"),
        DropGenericTable(DELETE, "/catalog/v1/{prefix}/namespaces/{namespace}/generic-tables/{table}"),
        RenameGenericTable(POST, "/catalog/v1/{prefix}/generic-tables/rename"),
        LoadGenericTableCredentials(GET, "/catalog/v1/{prefix}/namespaces/{namespace}/generic-tables/{table}/credentials"),
    }
...
mod test {
    ...
    fn test_endpoint_completeness() {
        ...
        // Load YAML files
        let management_yaml =
            include_str!("../../../../docs/reference/openapi/management-open-api.yaml");
        let catalog_yaml =
            include_str!("../../../../docs/reference/openapi/rest-catalog-open-api.yaml");
        let generic_table_yaml =
            include_str!("../../../../docs/reference/openapi/generic-table-open-api.yaml");
        ...
        // Process generic-table YAML paths (already prefixed with /catalog/v1)
