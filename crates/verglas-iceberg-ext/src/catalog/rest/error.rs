...
impl ErrorModel {
    ...
    pub fn from_io_error_with_code(
        io_error: verglas_catalog_io::IOError,
        code: impl Into<u16>,
        detail: &str,
    ) -> Self {
    ...
    #[must_use]
    pub fn from_io_error(io_error: verglas_catalog_io::IOError, detail: &str) -> Self {
        ...
        let code = match io_error.kind() {
            verglas_catalog_io::ErrorKind::Unexpected => StatusCode::INTERNAL_SERVER_ERROR.as_u16(),
            verglas_catalog_io::ErrorKind::NotFound => StatusCode::BAD_REQUEST.as_u16(),
            verglas_catalog_io::ErrorKind::RequestTimeout
            | verglas_catalog_io::ErrorKind::ServiceUnavailable
            | verglas_catalog_io::ErrorKind::ConfigInvalid
            | verglas_catalog_io::ErrorKind::PermissionDenied
            | verglas_catalog_io::ErrorKind::RateLimited
            | verglas_catalog_io::ErrorKind::ConditionNotMatch
            | verglas_catalog_io::ErrorKind::CredentialsExpired => {
                StatusCode::PRECONDITION_FAILED.as_u16()
            }
        };
