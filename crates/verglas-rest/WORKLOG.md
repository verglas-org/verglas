...
- #34: Removed the Rill runtime client, resource generation, and `/v1/dashboards` routes from the on-prem REST composition. Query, table, catalog, and S3 composition remain unchanged, and the removed route now returns not found.
